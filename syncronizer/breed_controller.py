...
from shared.model import Breed, Image_Breed, BreedTemperament, Temperament, Origin
...
class BreedController():
    ...
    def syncronize_breed_images(self):
        ...
        try:
            ...
            _records = Breed.select(Breed.breed_id)
                ...
                try:
                    ...
                    for _image_item in _images:
                        ...
                        try:
                            ...
                            self._logging.debug(_image_item)
                            _image, _image_created = Image_Breed.get_or_create(
                                                    id=_image_item['id'],
                                                    breed_id=_record_item,
                                                    url=_image_item['url'])
